<div class="row mb-5">
  <div class="col-4">
    <button class="border-0 bg-transparent shadow-none p-0 d-block mx-auto" data-bs-toggle="modal" data-bs-target="#recent-comments-{{ $user->id }}">
    @if($user->avatar)
  ...
  @include('user.profiles.modals.recentComments')
    </div>
  ...
  <div class="col">
    <div class="row mb-3 align-items-center">
      <div class="col-auto">
        {{-- user name --}}
        <h3 class="display-6 fw-bold mb-0">{{ $user->name }}</h3>        
      </div>
      <div class="col">
        {{-- button --}}
